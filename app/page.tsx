...
export default function Home() {
  ...
  const Sidebar = () => (
    <div className="hidden lg:flex w-[52px] h-screen bg-navy flex-col items-center py-4 gap-0.5 flex-shrink-0">
      <div className={`w-7 h-7 rounded-md bg-white/10 flex items-center justify-center mb-6 ${cx.btnIcon} hover:bg-white/20 hover:rotate-3 cursor-pointer`}><span className="text-white text-[10px] font-bold tracking-tight">NV</span></div>
    ...
    <div className="flex-1 h-full overflow-y-auto bg-nn-50 px-4 pt-5 pb-20 lg:p-6 lg:pb-6" style={{ animation: "fadeIn .2s ease" }}>
      <div className="lg:max-w-[1080px]">
        ...
        <div className="flex items-center justify-between lg:hidden mb-4" style={{ animation: "slideDown .3s ease" }}>
          <div className={`w-8 h-8 bg-navy rounded-lg flex items-center justify-center ${cx.btnIcon} hover:rotate-3`}><span className="text-white text-[10px] font-bold">NV</span></div>
